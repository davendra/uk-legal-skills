...
::: warning LOAD-BEARING REQUIREMENT
...
::: details AI Limitations to Be Aware Of
...
1. Run the relevant `/legal` command on your document
2. Review the output, paying attention to high-risk flags
3. Use the analysis as a briefing document for your solicitor
