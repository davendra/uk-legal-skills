...
|------|---------------------|
| `freelancer-contract` | Kill fee amount? Revision limits? Portfolio usage rights? UTR number / self-employment registration? |
...
> ⚠️ LEGAL DISCLAIMER: This agreement was AI-generated and does not constitute legal advice. Always have a qualified solicitor review any agreement before signing.
...
4.5. **Taxes.** Each Party is responsible for its own taxes. [For contractor agreements: "[Party A] acknowledges they are responsible for all self-employment taxes, including registering for Self Assessment with HMRC and obtaining a Unique Taxpayer Reference (UTR)."]
...
9.1. Each Party shall indemnify, defend, and hold harmless the other Party from and against any claims, damages, losses, and expenses (including reasonable legal costs) arising from:
...
10.2. **Mediation.** If negotiation fails, the Parties shall submit to mediation administered by [CEDR / LCIA / CIArb / agreed mediator] before filing any legal action.

10.3. **Governing Law.** This Agreement is governed by and construed in accordance with the laws of England and Wales.

10.4. **Jurisdiction.** The parties submit to the exclusive jurisdiction of the courts of England and Wales.

10.5. **Attorneys' Fees.** The prevailing party in any dispute shall be entitled to recover reasonable legal costs and costs.
...
> 📝 **Plain English:** Restrictions on competing businesses. NOTE: Under English law, restrictive covenants (including non-competes) are enforceable only if they are reasonable in scope, duration, and geographic area, and protect a legitimate business interest. See Tillman v Egon Zehnder [2019] UKSC 32.

🟡 **Risk Note:** Non-compete enforceability in England and Wales requires reasonableness. The covenant must protect a legitimate business interest (trade secrets, client connections, or workforce stability) and be no wider than necessary. Typical maximum enforced duration is 6-12 months. Consult a qualified solicitor.
...
- **Contractor Status (new Section):** Explicit independent contractor acknowledgment. List factors: own tools, own schedule, no benefits, multiple clients permitted. Include Self Assessment registration and UTR number reference. Note IR35 (off-payroll working rules) considerations.
...
5. **Next Steps:**
   ...
   - "Consider having a qualified solicitor in your jurisdiction review before signing."
