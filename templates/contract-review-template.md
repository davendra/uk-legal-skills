...
> ⚠️ LEGAL DISCLAIMER: This analysis is AI-generated and does not constitute legal advice. Always consult a qualified solicitor before signing.
...
| **Total Value** | [e.g., "£40,000" or "£120/hour, estimated £24,000" or "N/A"] |
| **Governing Law** | [e.g., "England and Wales" or "Not specified"] |
...
- **Why it's risky:** [Specific explanation of the danger. Quantify where possible. Example: "This is one-sided indemnification — you bear all legal costs even if the client contributed to the problem. In a typical dispute, legal fees alone can run £16,000-£80,000+."]

- **What you could lose:** [Concrete impact — dollars, rights, opportunities. Example: "£40,000+ in potential legal fees if a dispute arises, plus you waive the right to countersue for their contribution to any damages."]
...
- **[Flag Title]:** [Description. Example: "Non-compete clause must be reasonable in scope, duration, and geographic area to be enforceable under English law (Tillman v Egon Zehnder [2019] UKSC 32). Clauses exceeding 12 months are rarely upheld."]

- **[Flag Title]:** [Description. Example: "Contract involves processing EU personal data but contains no GDPR-compliant Data Processing Agreement. A DPA addendum is required under UK GDPR Article 28."]

- **[Flag Title]:** [Description. Example: "Governing law is set to Jersey, but both parties are in Manchester. This may create unnecessary complexity and expense in dispute resolution."]
...
7. [ ] Consult a qualified solicitor before signing
