...
def build_pdf(data, output_path):
    ...
    story.append(Paragraph(
        ...
        "It is intended as a starting point for review. Always consult a qualified solicitor "
    ...
    story.append(Paragraph(
        ...
        "It does not constitute legal advice. Consult a qualified solicitor before signing.",
        styles["Disclaimer"]
    ))
    story.append(Paragraph(
