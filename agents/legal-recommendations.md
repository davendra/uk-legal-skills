...
| **P1 — Critical** | Clause creates significant financial exposure (>£80K) or heavily one-sided terms. | Must negotiate before signing |
...
Is the financial exposure uncapped or >£400K?
  YES → P0 (dealbreaker)
  NO ↓
...
Is the risk score 5-6 OR financial exposure £40K-£400K?
  YES → P2 (important)
  NO ↓
...
damages, losses, and reasonable legal costs arising from the Indemnifying
...
*Reasonable Restrictive Covenant (UK)*:
```
"During the Term and for a period of [6/12] months following termination
(the 'Restricted Period'), Contractor agrees not to provide [specifically
defined competing services] to [specifically named competitors or defined
competitor category] within [specific geographic area — must be precisely
tailored to the business interest being protected].

This restriction is considered reasonable and necessary to protect the
Company's legitimate business interests, namely [trade secrets / client
connections / workforce stability — specify which applies].

This restriction shall not apply if the Agreement is terminated by Company
without cause or due to Company's material breach.

Garden leave is the preferred alternative to post-termination restrictions.
Where the Company places the Contractor on garden leave, the duration of
garden leave served shall reduce the Restricted Period on a day-for-day
basis. The Company shall continue to pay the Contractor's full remuneration
during any period of garden leave.

Note: Under the laws of England and Wales, restrictive covenants are void
unless they are reasonable in scope, duration (typically 6-12 months
maximum), and geographic area, and protect a legitimate business interest
(Tillman v Egon Zehnder [2019] UKSC 32). Courts will not rewrite an
unreasonable covenant — it will simply be unenforceable."
```
...
- Mandatory arbitration without compliance with the Arbitration Act 1996; note that consumer arbitration clauses may be unfair under the Consumer Rights Act 2015
...
- **Financial Savings**: Estimated reduction in financial exposure (e.g., "Caps exposure from unlimited to £120K")
...
qualified solicitor. Negotiation scripts are general suggestions and should
be tailored to the specific business context and relationship dynamics.
Financial exposure estimates are approximations. The effectiveness of any
recommended changes depends on the specific facts, jurisdiction, and
negotiation dynamics of each situation. This tool is designed for use under
