...
- Duration exceeds 6 months (12+ months is rarely enforceable; 6 months is more typical for UK restrictive covenants)
- UK courts rarely enforce broad geographic restrictions; they must be precisely tailored to the business interest being protected
...
- Covers independent contractors (very difficult to enforce in UK; IR35 considerations apply)
...
Component Score: [0-100] (100 = low-risk balanced contract; 0 = unacceptable risk; contributes 25% to Contract Review Score)
...
| 2 | 7.1 | 2-year nationwide non-compete | NC, RC | 8 | 7 | £160K-£400K est. | 8 | 8 | Party A |
...
reasonable legal costs) arising out of or relating to Contractor's
...
Financial Exposure:
- Single lawsuit defence costs: £40,000 - £400,000+
...
All findings should be reviewed by a qualified solicitor. This tool is
designed for use under the laws of England and Wales.
```
