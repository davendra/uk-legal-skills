...
| **Insurance** | INS | Required maintenance of insurance coverage | Maintain £2M public liability; Provide certificate annually |
| **Compliance** | COMP | Required adherence to laws, regulations, or standards | UK GDPR compliance; Cyber Essentials or ISO 27001 certification maintenance |
...
|---|---|---|---|---|---|---|---|---|
| 1 | 2.1 | Contractor | PERF | Deliver Phase 1 software build | Effective Date | 60 calendar days | 15 business days | Termination right + liquidated damages of £400/day |
| 2 | 3.1 | Company | PAY | Pay monthly service fee of £4,000 | Invoice receipt | Net 30 calendar days | 10 business days after written notice | 1.5%/month interest; acceleration after 60 days past due |
...
| 5 | 7.1 | Contractor | REST | Non-compete restriction | Termination | 24 months post-termination | N/A | Injunctive relief + liquidated damages of £40,000 |
...
Component Score: [0-100] (derive from obligation clarity, deadline quality, balanced remedies, and exposure certainty; contributes 15% to Contract Review Score)
...
All findings should be reviewed by a qualified solicitor. Calendar
reminders and operational timelines should be verified independently.
