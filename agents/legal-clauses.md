...
| **Data Protection** | Personal data handling, UK GDPR / DPA 2018 compliance, data processing | Data Protection, Privacy, Data Processing Agreement |
...
- **Employment Agreement**: Prioritize non-compete (must pass UK reasonableness test), confidentiality, termination, benefits (statutory sick pay, pension auto-enrolment, holiday entitlement of 28 days)
...
|---|---|---|---|---|---|---|
| 1 | 2.1 | Payment Terms | Payment | Auto-Renewal | Company pays £4,000/month within 30 days of invoice. Late payments accrue 1.5% monthly interest. | 4 |
...
| 3 | 7.1 | Non-Competition | Non-Compete | Exclusivity | Contractor cannot work for any competitor within the M25 area for 12 months after termination. Note: even this geographic and temporal scope may be challenged as too broad under UK law. | 3 |
...
Component Score: [0-100] (convert completeness, missing clauses, conflicts, and defined-term issues into the 20% Clause Analysis input)
...
should be reviewed by a qualified solicitor or barrister before any decisions
